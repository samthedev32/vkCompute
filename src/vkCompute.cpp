...
void vkCompute::run() {
  ...
  submitInfo.pSignalSemaphores = nullptr; //&computeFinishedSemaphores;
  ...
  printf("%f %f %f\n", ((float *)data)[0], ((float *)data)[1],
         ((float *)data)[2]);
  vkUnmapMemory(device, shaderStorageBuffersMemory);
}
...
void vkCompute::populateDebugMessengerCreateInfo(
...
void vkCompute::setupDebugMessenger() {
  if (!enableValidationLayers)
    return;
...
void vkCompute::pickPhysicalDevice() {
...
void vkCompute::createLogicalDevice() {
...
void vkCompute::createComputeDescriptorSetLayout() {
...
void vkCompute::createCommandPool() {
...
void vkCompute::createShaderStorageBuffers() {
...
void vkCompute::createUniformBuffers() {
...
void vkCompute::createDescriptorPool() {
...
void vkCompute::createComputeDescriptorSets() {
...
void vkCompute::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
...
void vkCompute::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer,
                           VkDeviceSize size) {
...
uint32_t vkCompute::findMemoryType(uint32_t typeFilter,
...
void vkCompute::createComputeCommandBuffers() {
  VkCommandBufferAllocateInfo allocInfo{};
  allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
  allocInfo.commandPool = commandPool;
  allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void vkCompute::recordComputeCommandBuffer(VkCommandBuffer commandBuffer) {
  VkCommandBufferBeginInfo beginInfo{};
  beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
...
void vkCompute::createSyncObjects() {
...
void vkCompute::updateUniformBuffer(uint32_t currentImage) {
...
VkShaderModule vkCompute::createShaderModule(const std::vector<char> &code) {
...
VkSurfaceFormatKHR vkCompute::chooseSwapSurfaceFormat(
...
VkPresentModeKHR vkCompute::chooseSwapPresentMode(
...
bool vkCompute::isDeviceSuitable(VkPhysicalDevice device) {
...
bool vkCompute::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices vkCompute::findQueueFamilies(VkPhysicalDevice device) {
...
bool vkCompute::checkValidationLayerSupport() {
  uint32_t layerCount;
...
VKAPI_ATTR VkBool32 VKAPI_CALL vkCompute::debugCallback(
